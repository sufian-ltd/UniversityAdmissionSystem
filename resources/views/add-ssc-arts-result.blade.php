...
<div class="container">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name4" value="Economics" maxlength="4"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name6" value="History"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name7" value="Sociology" maxlength="4"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name8" value="Social Work" maxlength="4"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name9" value="Statistics" maxlength="4"></td>
            <td>
