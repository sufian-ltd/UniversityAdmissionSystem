...
<div class="container">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name4" value="Social Science" maxlength="4"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name6" value="Physics"></td>
            <td>
        ...
        <tr>
            ...
            <input type="hidden" name="subject_name7">
            ...
            <td><input class="form-control" readonly type="text" name="subject_name7" value="Chemistry" maxlength="4"></td>
            <td>
        ...
        <tr>
            ...
            <input type="hidden" name="subject_name8">
            ...
            <td><input class="form-control" readonly type="text" name="subject_name8" value="Biology" maxlength="4"></td>
            <td>
        ...
        <tr>
            ...
            <input type="hidden" name="subject_name9">
            ...
            <td><input class="form-control" readonly type="text" name="subject_name9" value="Higher Mathematics" maxlength="4"></td>
            <td>
