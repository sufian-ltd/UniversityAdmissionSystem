...
<div class="container">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name4" value="Physics" maxlength="4"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name5" value="Chemistry"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name6" value="Biology"></td>
            <td>
