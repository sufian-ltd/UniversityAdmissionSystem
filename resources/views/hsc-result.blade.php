...
<div class="container">
    <br/><br/>
    <div align="center">
        <form action="{{ route('hscResult') }}" method="get" style="width: 500px">
            ...
            <div class="input-group">
                ...
                <input class="form-control" type="number" name="roll_no" id="roll_no" placeholder="Enter Valid HSC Roll No">
            </div>
            <br/>
            <div class="input-group">
