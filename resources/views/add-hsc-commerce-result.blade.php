...
<div class="container">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name3" value="Accounting"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name4" value="Finance" maxlength="4"></td>
            <td>
        ...
        <tr>
            ...
            <td><input class="form-control" readonly type="text" name="subject_name5" value="Economics"></td>
            <td>
        ...
        <tr>
            ...
            <td>
                <select name="subject_name6" class="form-control">
                    <option value="Compulsory">Compulsory</option>
                    <option value="Additional">Additional</option>
                </select>
            </td>
